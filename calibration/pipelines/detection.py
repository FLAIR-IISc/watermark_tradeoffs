...
from calibration.dataset import BaseDataset
from calibration.tools.text_editor import TextEditor
...
class WatermarkDetectionPipeline:
    ...
    def _get_progress_bar(self, iterable):
        ...
        if self.show_progress:
            return tqdm(iterable, desc="Performing watermark detection", leave=True)
        return iterable
