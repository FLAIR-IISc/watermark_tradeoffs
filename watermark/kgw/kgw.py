...
class KGWConfig:
    ...
    def __init__(self, algorithm_config: str, gamma, delta, transformers_config: TransformersConfig, *args, **kwargs) -> None:
        ...
        self.gamma = config_dict['gamma'] if gamma is None else gamma
...
class KGW(BaseWatermark):
    ...
    def __init__(self, algorithm_config: str, gamma, delta, transformers_config: TransformersConfig, *args, **kwargs) -> None:
        """
            ...
            Parameters:
                ...
                transformers_config (TransformersConfig): Configuration for the transformers model.
        """
        self.config = KGWConfig(algorithm_config, gamma, delta, transformers_config)
    ...
    def get_effective_gamma_and_delta(self, text: str, *args, **kwargs) -> tuple[float, float]:
        """Get effective gamma and delta"""

        return self.config.gamma, self.config.delta