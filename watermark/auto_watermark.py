...
class AutoWatermark:
    ...
    def load(algorithm_name, gamma=None, delta=None, algorithm_config=None, transformers_config=None, *args, **kwargs):
        ...
        watermark_instance = watermark_class(algorithm_config, gamma, delta, transformers_config)
